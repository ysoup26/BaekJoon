<Window x:Class="WpfGUI.View.Login1"
        ...
        mc:Ignorable="d"
        Title="Window1" Width="1280" Height="720">
    <Window.Resources>
    ...
    <Grid>
        ...
        <Grid>
            ...
            <Border Grid.Row="1" Grid.Column="1" BorderBrush="White" BorderThickness="0.8" CornerRadius="20">
                <Grid>
                    <Grid.Background>
                        <ImageBrush ImageSource="/View/1-blur.jpg" Stretch="None"/>
                    </Grid.Background>
                    <Grid.Clip>
                        <RectangleGeometry RadiusX="20" RadiusY="20" Rect="0,0,375.78,486"/>
                    </Grid.Clip>
                    <Grid.RowDefinitions>
                    ...
                    <Grid Grid.Row="0">
                        <StackPanel Orientation="Vertical" VerticalAlignment="Bottom">
                            <StackPanel Orientation="Horizontal" HorizontalAlignment="Center">
                                <Border Padding="20 4" Margin="0 0 10 0" Background="#FF4C5F7C" CornerRadius="15" BorderBrush="Transparent" BorderThickness="1">
                                    <Grid>
                                        <Button  Background="Transparent" BorderBrush="Transparent" Foreground="White" >Sign In</Button>
                                    </Grid>
                                </Border>
                                <Border Padding="20 4" Background="#FF14233F" CornerRadius="15" BorderBrush="Transparent" BorderThickness="1">
                                    <Grid>
                                        <Button  Background="Transparent" BorderBrush="Transparent" Foreground="White" >Sign Up</Button>
                                    </Grid>
                                </Border>
                            </StackPanel>
                            <TextBlock Margin="20" Text="Sign Up" Foreground="White" FontSize="24" HorizontalAlignment="Center" VerticalAlignment="Bottom" FontWeight="Bold"/>
                        </StackPanel>
                    </Grid>
                    <Grid Grid.Row="1">
                        <Grid.RowDefinitions>
                        ...
                        <Border Grid.Row="0" Margin="20 8" CornerRadius="25" 
                        ...
                        <Border Grid.Row="1" Margin="20 8" CornerRadius="25" 
                                BorderBrush="Transparent" BorderThickness="1" Background="#FF4C5F7C">
                            <Grid>
                                <TextBox 
                                    Foreground="White" 
                        ...
                        <Border Grid.Row="2" Margin="20 8" CornerRadius="25" 
                                BorderBrush="Transparent" BorderThickness="1" Background="#FF4C5F7C">
                            <Grid>
                                <TextBox 
                                    Foreground="White" 
                        ...
                        <Border  Grid.Row="3" Margin="20 0 " CornerRadius="25" BorderBrush="Transparent" BorderThickness="1">
                            <CheckBox Foreground="White" HorizontalAlignment="Right" VerticalAlignment="Center">Remember me</CheckBox>
                        </Border>
                        <Border Grid.Row="4" Margin="20 8" Background="#FF14233F" CornerRadius="25" BorderBrush="Transparent" BorderThickness="1">
                            <Grid>
                                <Button  Background="Transparent" BorderBrush="Transparent" Foreground="White" >Sign up -></Button>
                            </Grid>
                        </Border>
